...
- Bot classification
- VPN/proxy detection
- GeoLite2 download checksum (`.sha256` sidecar) verification — deferred pending a live contract check against a real MaxMind account; see `docs/SECURITY.md`
