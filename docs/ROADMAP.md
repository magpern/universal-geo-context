...
**Status: M1–M7 shipped. v1.0.0 is the first production-ready release; v1.1.0 adds managed GeoLite2 downloads; v1.2.0 restructures admin navigation.**
...
## Explicitly deferred to 1.3 or later
